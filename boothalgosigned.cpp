...
int main()
{
    ...
    cin>>num2;
    string multiplicant="";
    multiplicant=to_binary(abs(num1));
    if(num1>=0)
        multiplicant='0'+multiplicant;
    else
	{
        multiplicant='0'+multiplicant;
		string m1=complement(multiplicant);
		multiplicant=add_one(m1);
	}
	cout<<"Multiplicant : "<<multiplicant<<endl;
    ...
    string multiplier="";
    multiplier=to_binary(abs(num2));
    for(int i=multiplier.size();i<multiplicant.size()-1;i++)
    {
	...
	{
        multiplier='0'+multiplier;
		string s1=complement(multiplier);
		multiplier=add_one(s1);
	}
